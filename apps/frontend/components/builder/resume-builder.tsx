...
const ResumeBuilderContent = () => {
  ...
  return (
    <div className="h-screen w-full bg-background flex justify-center items-center p-4 md:p-8">
      {/* Main Container */}
      <div className="w-full h-full max-w-[90%] md:max-w-[95%] xl:max-w-[1800px] border border-border bg-background shadow-pb-lg flex flex-col">
        {/* Header Section */}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                {hasUnsavedChanges && (
                  <span className="flex items-center gap-1 text-xs font-mono text-amber-600 bg-warning/10 px-2 py-1 border border-amber-200">
