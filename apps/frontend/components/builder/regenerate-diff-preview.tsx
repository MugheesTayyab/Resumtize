    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] p-0 gap-0 rounded-lg overflow-hidden">
        ...
        <div className="px-6 pt-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-green-50 border border-green-200 text-success font-mono text-xs">
              ...
              {expandedItems.has(item.item_id) && (
                <div className="border-t border-border">
                  ...
                  <div className="p-4 border-b border-border">
                    ...
                    <div className="border-2 border-border bg-white p-3 space-y-1">
